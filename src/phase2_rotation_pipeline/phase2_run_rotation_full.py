...
OUTPUT_CSV = PROJECT_ROOT / "data" / "processed" / "sector18_rotation_results_full.csv"

print(f"Reading input from: {INPUT_SAMPLE}")
...
print("\n--- PHASE 2: ROTATION PERIOD ANALYSIS (FULL RUN) ---")
...
print(f"Total stars in input sample: {len(sample)}")
